...
architecture sim of multiplication_tb is
    ...
    -- input signals
    signal v_num1 : BTERN_LOGIC_VECTOR(3 downto 0) := BTERN_ULOGIC_VECTOR'("0+0+"); -- decimal +10
    signal v_num2 : BTERN_LOGIC_VECTOR(3 downto 0) := BTERN_ULOGIC_VECTOR'("0-0-"); -- decimal -10
