...
* The recommended open-source VHDL compiler is [GHDL](https://github.com/ghdl/ghdl?tab=readme-ov-file#getting-ghdl) >= v5.1.1.
    * The commands used to compile the TVL library can be found in _.vscode/tasks.json_ under the section "Compile TVL Library".
* The library has only been verified to work with VHDL 2008.
