...
argument-hint: <testbench-entity> [--stop-time=<N>ns]
---

Read [../../agent-references/simulate-project.md](../../agent-references/simulate-project.md) and simulate the testbench named in `$ARGUMENTS` (e.g. `flip_flop_tb`, `kleene_binaryfunc_tb`).
