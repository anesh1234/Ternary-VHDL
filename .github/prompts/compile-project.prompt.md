...
Read [../../agent-references/compile-project.md](../../agent-references/compile-project.md) and follow the recipe for the project supplied by the user (e.g. `rtl_designs`, `rtl_designs/old_testbench/kleene`). If no project is given, default to `rtl_designs`.
