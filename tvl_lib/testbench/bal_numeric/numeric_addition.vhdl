...
--           integers for comprehensive coverage, and 
--           randomized 19-trit integers. Properties such as 
--           commutativity and associativity are implicitly tested by 
--           proving that the results are the same as for the 
--           integer type.
-- --------------------------------------------------------------------
...
begin
  ...
  begin
    ...
    if run("All 6-trit VectorVector") then
      ...
      -- ===============================================
      -- Adds all 6-trit numbers and tests 
     ...
     -- Weak values VectorVector
      ...
      check_equal(TO_STRING(BTERN_LOGIC_VECTOR'("HLL") +  -- 5
                            BTERN_LOGIC'('+')),           -- + 1
                  TO_STRING(BTERN_LOGIC_VECTOR'("+-0"))); -- = 6

      check_equal(TO_STRING(BTERN_LOGIC'('-') +            -- -1
                            BTERN_LOGIC_VECTOR'("MMHM")),  -- + 3
                  TO_STRING(BTERN_LOGIC_VECTOR'("00+-"))); -- = 2
